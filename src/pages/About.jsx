  ...
  <h2 className="main-title">
    WE KEEP YOUR PETS <br /> HAPPY ALL TIME
                        ...
                        <div className="tabs">
                            ...
                            <button
                                className='tab-btn' style={{backgroundColor:'white'}}
                            >
                                ACHIEVEMENTS
                            </button>
                        </div>
                            ...
                            {activeTab === 'achievements' && (
                                <p>We have achieved excellence in manufacturing and exporting high-quality equestrian products worldwide, maintaining long-term relationships with our global partners.</p>
                            )} */}
                        </div>
                    </div>
                </div>
